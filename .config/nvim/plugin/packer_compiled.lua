...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    ...
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["themer.lua"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/themer.lua",
