...
_G.packer_plugins = {
  ...
  ["cmp-spell"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/cmp-spell",
  ...
  ["coverage.vim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/coverage.vim",
    url = "https://github.com/ruanyl/coverage.vim"
  },
  everforest = {
    loaded = true,
